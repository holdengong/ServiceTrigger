...
namespace ServiceTrigger
{
    ...
    public class ServiceTriggerWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ServiceTriggerWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ServiceTriggerWebCoreModule).GetAssembly());
        }
    }
}
